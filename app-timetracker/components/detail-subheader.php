...
<div class="timetracker-module-subheader">
	<div class="flex-md flex-wrap align-items-center justify-content-space-between">
		<!-- status -->
	...
	<!-- New row after toggles on the right -->
		...
		<?php if(str_contains(FWAPPS_TEMPLATE,'project-detail') || str_contains(FWAPPS_TEMPLATE,'client-detail')): ?>
			<div class="flex-2-0 border-style-solid-top border-color-theme-polar-contrast border-width-thin-top align-self-stretch flex-xs align-items-center padding-small-x flex-wrap">
					...
					<?php if(!$args['can_edit']): ?>
						...
						<div class="flex-0-0 position-relative flex-xs align-items-center padding-small flex-nowrap">
							...
							<div class="flex-1-1 padding-small-left">
								<p class="no-margin">No members</p>
							</div>
						</div>
					<?php endif; ?>
				<?php endif; ?>
				...
				<?php if($args['can_edit']): ?>
					...
					<form class="flex-0-0 position-relative flex-xs align-items-center padding-small flex-nowrap">
