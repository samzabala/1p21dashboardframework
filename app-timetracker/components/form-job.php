		...
		<div class="grid-col-xs-12 grid-col-sm-9 grid-col-md-7">
			<form action="">
				<div class="input-wrapper input-wrapper-vertical input-wrapper-block p">
					<label for="job-name" class="input input-label font-weight-700">Name</label>
					
					<!-- @NOTE .input
						classes to add:
							input-error => if field has an error
					-->
					<input id="job-name" placeholder="Enter a Job name" class="input input-box" />
				...
				<div class="input-wrapper input-wrapper-vertical input-wrapper-block p">
					<label for="job-description" class="input input-label font-weight-700">Description</label>
					
					<!-- @NOTE .input
						classes to add:
							input-error => if field has an error
					-->
					<textarea name="" placeholder="Enter a description" id="job-description" rows="3" class="input input-box input-box-multiline input-block"></textarea>
				...
				<div class="input-wrapper input-wrapper-vertical input-wrapper-block p">
					<label for="job-department" class="input input-label font-weight-700">Department</label>			
					...
					<!-- @NOTE .input
						classes to add:
							input-error => if field has an error
					-->
					<input id="job-department" placeholder="Enter a Job department" class="input input-box" list="departments" />
				...
				<div class="input-wrapper input-wrapper-vertical input-wrapper-block p">
					<label for="job-description" class="input input-label font-weight-700">Task Categories</label>
					<div class="flex-1-1">
						<!-- @loop .grid grid-flex -->
								...
								<div class="grid-col flex-1-1 no-margin-top">
									...
									<!-- @NOTE .input
										classes to add:
											input-error => if field has an error
									-->
									<input id="department-task-categories-[REPLACE]" placeholder="Enter a Task Category" class="input input-box input-block" />
								...
								<!-- @PLACEHOLDER: Delete when ready -->
									...
									<?php for($i = 0; $i < 6; $i++): ?>
										...
										<div class="grid grid-flex grid-compact grid-flex-fixed flex-nowrap">
											<div class="grid-col flex-1-1 no-margin-top">
												...
												<input id="department-task-categories-<?=$i ?>" placeholder="Enter a Task Category" class="input-error input input-box input-block" />
									...
									<div class="grid grid-flex grid-compact grid-flex-fixed flex-nowrap">
										<div class="grid-col flex-1-1 no-margin-top">
											...
											<input id="department-task-categories-<?=$i + 1 ?>" placeholder="Enter a Task Category" class="input input-box input-block" />
										</div>
										<div class="grid-col flex-0-0 no-margin-top flex-xs">
											<!-- @if it is a new entry -->
												<button title="Add" class="btn btn-primary-glassy btn-symbol">
				...
				<div class="input-wrapper input-wrapper-vertical input-wrapper-block p">
					<label for="job-report-to" class="input input-label font-weight-700">Reports to</label>
					...
					<!-- @NOTE .input
						classes to add:
							input-error => if field has an error
					-->
					<input id="job-report-to" placeholder="Enter a Job department" class="input input-box" list="report-to" />
				</div>
