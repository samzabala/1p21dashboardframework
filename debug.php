...
<script>
    ...
    //DEMO ENDS HERE
		...
		<div class="accordion">
			...
			<div class="round-corner ratio-1-by-1 ratio ratio-me background-theme-contrast">
			...
			<div class="radius-top ratio-1-by-1 ratio ratio-me background-theme-contrast">
				<span class="ratio ratio-child-contain">top</span>
			</div>



			<div class="radius-bottom ratio-1-by-1 ratio ratio-me background-theme-contrast">
				<span class="ratio ratio-child-contain">bottom</span>
			</div>


			<div class="radius-left ratio-1-by-1 ratio ratio-me background-theme-contrast">
				<span class="ratio ratio-child-contain">left</span>
			</div>



			<div class="radius-right ratio-1-by-1 ratio ratio-me background-theme-contrast">
				<span class="ratio ratio-child-contain">right</span>
			</div>


			<div class="radius-top-left ratio-1-by-1 ratio ratio-me background-theme-contrast">
				<span class="ratio ratio-child-contain">top-left</span>
			</div>



			<div class="radius-top-right ratio-1-by-1 ratio ratio-me background-theme-contrast">
				<span class="ratio ratio-child-contain">top-right</span>
			</div>

			<div class="radius-bottom-left ratio-1-by-1 ratio ratio-me background-theme-contrast">
			...
			<div class="radius-small ratio-1-by-1 ratio ratio-me background-theme-contrast">
				<span class="ratio ratio-child-contain">oHOHO</span>
			</div>
...
<div class="accordion">
	...
	<p>
		...
		<div class="accordion">
			<div class="grid grid-flex grid-flex-fixed flex-frid-compact">
				...
				<div class="grid-col-xs-12 grid-col-md-3">
					<div class="asset">
						...
						<p class="asset-title">bitch-ass-obscure-or-nonweb-image-type-or-vector-shit-that-dont-like-fit-cover.ps</p>
						<p class="asset-caption">69kb</p>
					</div>
				</div>
				...
				<div class="grid-col-xs-12 grid-col-md-3">
					<div class="asset">
						...
						<p class="asset-title">bitch-ass-obscure-or-nonweb-image-type-or-vector-shit-that-dont-like-fit-cover.ai</p>
						<p class="asset-caption">69kb</p>
					</div>
				</div>
				...
				<div class="grid-col-xs-12 grid-col-md-3">
					<div class="asset">
						...
						<p class="asset-title">bitch-ass-obscure-or-nonweb-image-type-or-vector-shit-that-dont-like-fit-cover.xd</p>
						<p class="asset-caption">69kb</p>
					</div>
				</div>
				...
				<div class="grid-col-xs-12 grid-col-md-3">
					<div class="asset">
						...
						<p class="asset-title">Well Shit.indb</p>
						<p class="asset-caption">69kb</p>
					</div>
				</div>
...
<h3>Nadia's code</h3>
	...
	<div class="module-function filter-dropdown-project">
		...
		<ul data-dropdown-width="100%" class="text-align-left dropdown dropdown-top-flush dropdown-center-x">
			...
			<div class="grid grid-flex grid-flex-fixed grid-compact input-small">
				<div class="grid-col-sm-6 grid-col-md-4 grid-col-lg-3 ">
					<label class="input input-label" >Client</label>
				</div>
				<div class="grid-col-sm-6 grid-col-md-8 grid-col-lg-9 ">
		...
		<div class="accordion">
				...
				theme<br>
				<span class="btn btn-symbol well btn-theme-polar ">
					<i class="symbol symbol-plus"></i>
				</span>
				theme polar<br>
				<span class="btn btn-symbol well btn-theme-outline ">
					<i class="symbol symbol-plus"></i>
				</span>
				theme outline <br>
				<span class="btn btn-symbol well btn-theme-polar-outline ">
					<i class="symbol symbol-plus"></i>
				</span>
...
<script>
	var fuckinModalCallback =  function() {
		...
		<div class="accordion">
			...
			<h2>Tooltip on click </h2>
				...
				<a href="#" class="btn btn-primary"
					...
					Bitch boi on the bottom and badge is large
				</a>
		...
		<div class="accordion">
			...
			<h2>Combination of dem classes</h2>
		...
		<div class="accordion">
			<div class="accordion-group">
				...
				<div id="other-other-bitch-accordion" class="accordion">
					...
					<input class="input input-blend" type="date">
					<input class="input input-blend" type="datetime-local">
					<input class="input input-blend" type="email">
					<input class="input input-blend" type="file">
					<input class="input input-blend" type="hidden">
					<input class="input input-blend" type="image">
					<input class="input input-blend" type="month">
					<input class="input input-blend" type="number">
					<input class="input input-blend" type="password">
					...
					<input class="input input-blend" type="search">
					<input class="input input-inline" type="submit">
					<input class="input input-blend" type="tel">
					<input class="input input-blend" type="text">
					<input class="input input-blend" type="time">
					<input class="input input-blend" type="url">
					<input class="input input-blend" type="week">
					<input class="input input-blend" list="browsers">
					<datalist class="input" id="browsers">
						<option value="Internet Explorer">
						</option><option value="Firefox">
						</option><option value="Chrome">
					...
					<select class="input input-blend" name="cars">
					<option value="volvo">Volvo</option>
					<option value="saab">Saab</option>
					<option value="fiat">Fiat</option>
					<option value="audi">Audi</option>
					...
					<select class="input input-blend" name="cars" multiple>
					<option value="volvo">Volvo</option>
					<option value="saab">Saab</option>
					<option value="fiat">Fiat</option>
					<option value="audi">Audi</option>
					...
					<textarea class="input input-blend" name="message" rows="10" cols="30">The cat was playing in the garden.</textarea>
					...
					<input class="input input-error input-blend" type="date">
					<input class="input input-error input-blend" type="datetime-local">
					<input class="input input-error input-blend" type="email">
					<input class="input input-error input-blend" type="file">
					<input class="input input-error input-blend" type="hidden">
					<input class="input input-error input-blend" type="image">
					<input class="input input-error input-blend" type="month">
					<input class="input input-error input-blend" type="number">
					<input class="input input-error input-blend" type="password">
					...
					<input class="input input-error input-blend" type="search">
					<input class="input input-error input-inline" type="submit">
					<input class="input input-error input-blend" type="tel">
					<input class="input input-error input-blend" type="text">
					<input class="input input-error input-blend" type="time">
					<input class="input input-error input-blend" type="url">
					<input class="input input-error input-blend" type="week">
					<input class="input input-error input-blend" list="browsers">
					...
					<select class="input input-error input-blend" name="cars">
					<option value="volvo">Volvo</option>
					<option value="saab">Saab</option>
					<option value="fiat">Fiat</option>
					<option value="audi">Audi</option>
					...
					<select class="input input-error input-blend" name="cars" multiple>
					<option value="volvo">Volvo</option>
					<option value="saab">Saab</option>
					<option value="fiat">Fiat</option>
					<option value="audi">Audi</option>
					...
					<textarea class="input input-error input-blend" name="message" rows="10" cols="30">The cat was playing in the garden.</textarea>
					...
					<input class="input input-large input-blend" type="date">
					<input class="input input-large input-blend" type="datetime-local">
					<input class="input input-large input-blend" type="email">
					<input class="input input-large input-blend" type="file">
					<input class="input input-large input-blend" type="hidden">
					<input class="input input-large input-blend" type="image">
					<input class="input input-large input-blend" type="month">
					<input class="input input-large input-blend" type="number">
					<input class="input input-large input-blend" type="password">
					...
					<input class="input input-large input-blend" type="search">
					<input class="input input-large input-inline" type="submit">
					<input class="input input-large input-blend" type="tel">
					<input class="input input-large input-blend" type="text">
					<input class="input input-large input-blend" type="time">
					<input class="input input-large input-blend" type="url">
					<input class="input input-large input-blend" type="week">
					<input class="input input-large input-blend" list="browsers">
					...
					<select class="input input-large input-blend" name="cars">
					<option value="volvo">Volvo</option>
					<option value="saab">Saab</option>
					<option value="fiat">Fiat</option>
					<option value="audi">Audi</option>
					...
					<select class="input input-large input-blend" name="cars" multiple>
					<option value="volvo">Volvo</option>
					<option value="saab">Saab</option>
					<option value="fiat">Fiat</option>
					<option value="audi">Audi</option>
					...
					<textarea class="input input-large input-blend" name="message" rows="10" cols="30">The cat was playing in the garden.</textarea>
				...
				<div id="other-other-bitch-accordion" class="accordion">
					...
					<div class="nav nav-vertical">
						...
						<input class="input-input" type="button" value="Bitch">
						<input class="input-small" type="checkbox">
						<input class="input-small" type="color">
						<input class="input-small" type="date">
						<input class="input-small" type="datetime-local">
						<input class="input-small" type="email">
						<input class="input-small" type="file">
						<input class="input-small" type="hidden">
						<input class="input-small" type="image">
						<input class="input-small" type="month">
						<input class="input-small" type="number">
						<input class="input-small" type="password">
						<input class="input-small" type="radio">
						<input class="input-small" type="range">
						<input class="input-small" type="reset">
						<input class="input-small" type="search">
						<input class="input-small" type="submit">
						<input class="input-small" type="tel">
						<input class="input-small" type="text">
						<input class="input-small" type="time">
						<input class="input-small" type="url">
						<input class="input-small" type="week">
						<input class="input-small" list="browsers">
						<datalist class="input-small" id="browsers">
							<option value="Internet Explorer">
							</option><option value="Firefox">
							</option><option value="Chrome">
							</option><option value="Opera">
						...
						<select class="input-small" name="cars">
						<option value="volvo">Volvo</option>
						<option value="saab">Saab</option>
						<option value="fiat">Fiat</option>
						<option value="audi">Audi</option>
						...
						<select class=" input-small" name="cars" multiple>
						<option value="volvo">Volvo</option>
						<option value="saab">Saab</option>
						<option value="fiat">Fiat</option>
						<option value="audi">Audi</option>
						...
						<textarea class=" input-small" name="message" rows="10" cols="30">The cat was playing in the garden.</textarea>

						<hr>

						<input class="input-small" type="button" value="Bitch">
						<input class="input-small" type="checkbox">
						<input class="input-small" type="color">
						<input class="input-small" type="date">
						<input class="input-small" type="datetime-local">
					...
					<h3>dumbfuck in an input-group</h3>
		...
		<div class="accordion">
			...
			<div class="nav nav-vertical">
				...
				<a href="#" class="btn btn-large btn-secondary">secondary</a>

				<div class="btn-group">

					<a href="#" class="btn btn-accent">accent</a>
					<a href="#" class="btn btn-neutral">neutral</a>
					<a href="#" class="btn btn-success">Success</a>
					<a href="#" class="btn btn-caution">caution</a>
			...
			<button class="btn-group btn-group-horizontal btn-block">
			<span class="btn btn-default"><strong>00:00</strong> Hours</span>
			<span class="btn btn-primary">Add Time to Project <i class="symbol symbol-plus"></i></span>
			</button>
			<button class="btn-group btn-group-horizontal btn-block-mobile">
			<span class="btn btn-default"><strong>00:00</strong> Hours</span>
			<span class="btn btn-primary">Add Time to Project <i class="symbol symbol-plus"></i></span>
			</button>
		...
		<div class="accordion">
			...
			<?php foreach($supported_symbols as $symbol): ?>
				<a href="#" class="btn-group btn-group-horizontal btn-group-unite">
					<span class="btn btn-default">Symbol <?=$symbol?></span>
					<span class="btn btn-primary-outline btn-symbol"><i class="symbol symbol-<?=$symbol?>"></i></span>
				</a>
			<?php endforeach; ?>
			...
			<p>
				...
				<span class="highlight highlight-primary">
					<i class=" symbol symbol-<?=$symbol?>"></i> Symbol <?=$symbol?> 
				</span>
				<?php endforeach; ?>
			...
			<span class="highlight highlight-error"><i class="symbol symbol-time"></i> black panther</span>
		...
		<div class="accordion">
			...
			<?php
				...
				$calculated_gradient_angles = array(
					'',45, 90, 135,
				);
				?>
			<div style="
			...
			">
				...
				<?php foreach($calculated_gradient_angles as $angle): ?>
					<?php foreach($calculated_gradient_color_stops as $from): ?>
						<?php foreach($calculated_gradient_color_stops as $to): if($from !== $to): ?>
							<p
								class="<?= "background-gradient".($angle == '' ? '' : "-{$angle}")."-from-{$from}-to-{$to}" ?>">
								 <?=$angle ?><br>
								 from <?="{$from}" ?><br>
								 to <?= "{$to}"?><br>
							</p>
