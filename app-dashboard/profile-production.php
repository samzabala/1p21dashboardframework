				...
				<div class="table-wrapper">
					...
					<table class="text-vertical-align-middle">
						...
						<tr>
							...
							<td>
								<a href="<?=FWAPPS_ROOT_URL ?>?template=project&env=<?=FWAPPS_SLUG ?>" class="project-name color-inherit color-primary-hover">
									<span class="REPLACE">Client Name</span>
								</a>
							</td>

							<td>
								<a href="<?=FWAPPS_ROOT_URL ?>?template=project&env=<?=FWAPPS_SLUG ?>" class="project-task-name color-inherit color-primary-hover">
