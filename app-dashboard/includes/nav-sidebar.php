...
<ul class="nav-list">
	...
	<?php if(FWAPPS_SLUG == 'scoreboard'):?>
			...
			<li class="nav-item">
				...
				<span data-toggle="dropdown">
					<img class="nav-icon" data-src="<?=FWAPPS_ROOT_URL ?>/app-<?=FWAPPS_APP;?>/assets/images/icon-devs.svg">
	...
	<?php else: ?>
			...
			<li class="nav-item">
				...
				<!-- @IF has a dropdown -->
				<span data-toggle="dropdown">
					<img class="nav-icon" data-src="<?=FWAPPS_ROOT_URL ?>/app-<?=FWAPPS_APP;?>/assets/images/icon-designers.svg">
			...
			<li class="nav-item">
				...
				<!-- @IF has a dropdown -->
				<span data-toggle="dropdown">
					<img class="nav-icon" data-src="<?=FWAPPS_ROOT_URL ?>/app-<?=FWAPPS_APP;?>/assets/images/icon-managers.svg">
			...
			<li class="nav-item">
				...
				<!-- @IF has a dropdown -->
				<span data-toggle="dropdown">
					<img class="nav-icon" data-src="<?=FWAPPS_ROOT_URL ?>/app-<?=FWAPPS_APP;?>/assets/images/icon-sales.svg">
