<div class="module-grid">
	<div class="module">
		...
		<a href="#task-REPLACEwithPostTypeID-view" data-toggle="board">Toggle task modallyu view board</a>
		<a href="#task-REPLACEwithPostTypeID-edit" data-toggle="board">Toggle task modallyu add/edit board</a>
	</div>
</div>
