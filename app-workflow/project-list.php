		...
		<div class="module-content accordion open" id="favorite-projects">
			<!-- @if there are entries -->
				<div class="table-wrapper dashboard-table-wrapper-gutterless">
					<table class="table-small data-fave-projects">
						<tr>
						...
						<!-- @loop TR -->
							<tr>
								...
								<td class="dashboard-table-cell-max">
									<a href="<?=app_create_link(array('template'=>'project-view')) ?>" class="project-name text-wrap-ellipsis">
								...
								<td class="dashboard-table-cell-max">
									<!-- @if project has type -->
									<span href="<?=app_create_link(array('template'=>'project')) ?>" class="project-type text-wrap-ellipsis">
