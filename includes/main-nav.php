...
<div id="dashboard-block-main-nav" class="nav nav-sticky">
	...
	<a href="#"
		...
		class="btn color-primary-hover color-primary-active color-primary-focus background-primary-toggle color-global-background-toggle btn-symbol btn-no-radius dashboard-sidenav-toggle btn-no-shadow btn-large only-xs nav-toggle">
