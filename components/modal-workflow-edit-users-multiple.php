...
<div class="modal" data-modal-width="600px">
	...
	<?php endif; ?>
		...
		<div class="input-wrapper input-wrapper-vertical input-wrapper-block p">
			<label for="filter-REPLACEwithCorrespondingInputFieldName" class="input input-label">Choose &nbsp;<span class="filter-verbiage-text">REPLACEUserVerbiage</span>s</label>
			<!-- @NOTE
			...
			-->
			<input id="filter-REPLACEwithCorrespondingInputFieldName" name="filter-REPLACEwithCorrespondingInputFieldName" type="text" class="input input-block input-box" placeholder="Search profiles" />
		</div>
