...
<div class="modal" data-modal-max-width="600px">
	...
	<div class="input-wrapper input-wrapper-vertical input-wrapper-block p">
		...
		<input id="filter-REPLACEwithCorrespondingInputFieldName" name="filter-REPLACEwithCorrespondingInputFieldName" type="text" class="input input-block input-large input-single-line" placeholder="Search for workflux board" />
	</div>
