<div class="filter-sponsorships-meta display-block module-function text-align-left">
	<form action="/sponsorships/improved" method="get" class="flex-1-1">
		<div class="filter-sponsorships input-group input-group-horizontal input-group-responsive input-block">
			...
			<input type="text" placeholder="Client" name="filter-client" class="input input-single-line" />
			
			
			<!-- @placeholder option:not([selected]) -->
			<select class="input input-select"  name="filter-creator">
			...
			<input type="text" placeholder="Geo Area" name="filter-geoarea" class="input input-single-line" />
