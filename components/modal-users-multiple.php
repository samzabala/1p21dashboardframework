...
<div class="modal" data-modal-max-width="600px" data-modal-close="false">
		<input id="filter-user-multiple-ids-to-add" type="hidden">
	<label for="filter-user-multiple" class="input-label sr-only">Search</label>
	<div class="input-group input-group-block input-group-horizontal p">
		...
		-->
		<input id="filter-user-multiple" name="filter-user-multiple" type="text" class="input input-block input-large input-single-line" data-toggle="dropdown" placeholder="Choose PLACEHOLDER" />
		<button class="btn btn-symbol btn-default" onclick="REPLACEwithFunctionToClearSearchBox"><i class="symbol symbol-close"></i></button>
	</div>
	<ul class="dashboard-list-group-users list-group list-group-toggle-multiple list-group-toggle font-size-large">
		<!--
			@NOTE
			@dynamic @loop li 
				cclasses to add:
