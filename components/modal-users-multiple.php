...
<div class="modal" data-modal-max-width="600px">
	...
	<button data-toggle="modal-close" class="btn btn-primary-outline btn-block" onclick="REPLACEWithFnThatMakesChangesToCorrespondingInputFieldName">Set&nbsp;<span class="">REPLACEUserVerbage</span>s</button>
</div>