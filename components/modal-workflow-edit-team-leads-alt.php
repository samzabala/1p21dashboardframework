...
<div class="modal" data-modal-width="600px">
	...
	<div class="input-wrapper input-wrapper-vertical input-wrapper-block position-relative p">
		<h5 class="input input-label">Sales Rep</h5>
		<!-- @NOTE
		...
		<a href="#" data-toggle="dropdown" class="input input-box input-box input-box-select flex-xs align-items-center justify-content-space-between">
			<!-- if has user -->
		...
		<div class="dropdown dropdown-top-flush dropdown-center-x no-padding" data-dropdown-width="100%">
			...
			<button class="btn btn-block btn-primary no-radius" data-toggle="dropdown">Set sales rep</button>
		</div>
	</div>
	
	<div class="input-wrapper input-wrapper-vertical input-wrapper-block position-relative p">
		<h5 class="input input-label">Account Manager</h5>
		<!-- @NOTE
			replace placeholder with appropriate verbiage based on input field it fills in eg Team Leades: Choos Team Leads, Assigned To: Choose Asignee, etc
		-->
		...
		<div class="dropdown dropdown-top-flush dropdown-center-x no-padding" data-dropdown-width="100%">
			...
			<button class="btn btn-block btn-primary no-radius" data-toggle="dropdown">Set account manager</button>
		</div>
	</div>
	
	<div class="input-wrapper input-wrapper-vertical input-wrapper-block position-relative p">
		<h5 class="input input-label">Project Manager</h5>
		<!-- @NOTE
			replace placeholder with appropriate verbiage based on input field it fills in eg Team Leades: Choos Team Leads, Assigned To: Choose Asignee, etc
		-->
		...
		<div class="dropdown dropdown-top-flush dropdown-center-x no-padding" data-dropdown-width="100%">
			...
			<button class="btn btn-block btn-primary no-radius" data-toggle="dropdown">Set project manager</button>
		</div>
	</div>
	
	<div class="input-wrapper input-wrapper-vertical input-wrapper-block position-relative p">
		<h5 class="input input-label">Lead Designer</h5>
		<!-- @NOTE
			replace placeholder with appropriate verbiage based on input field it fills in eg Team Leades: Choos Team Leads, Assigned To: Choose Asignee, etc
		-->
		...
		<div class="dropdown dropdown-top-flush dropdown-center-x no-padding" data-dropdown-width="100%">
			...
			<button class="btn btn-block btn-primary no-radius" data-toggle="dropdown">Set lead designer</button>
		</div>
	</div>


	<div class="input-wrapper input-wrapper-vertical input-wrapper-block position-relative p">
		<h5 class="input input-label">Lead Developer</h5>
		<!-- @NOTE
			replace placeholder with appropriate verbiage based on input field it fills in eg Team Leades: Choos Team Leads, Assigned To: Choose Asignee, etc
		-->
		...
		<div class="dropdown dropdown-top-flush dropdown-center-x no-padding" data-dropdown-width="100%">
			...
			<button class="btn btn-block btn-primary no-radius" data-toggle="dropdown">Set lead developer</button>
		</div>
	</div>
	...
	<!-- Other team members: multiple list group toggle list for team members that dont need to be lead -->
		...
		<div class="input-wrapper input-wrapper-vertical input-wrapper-block position-relative p">
			<h5 class="input input-label">Select other team members</h5>
			
			<input id="<?=$args['post']?>-lead-others-id" name="<?=$args['post']?>-lead-others-id" type="hidden" />

			<div class="input-wrapper input-wrapper-vertical input-wrapper-block p">
				<label for="filter-<?=$args['post']?>-lead-others-id" class="input input-label sr-only">Search</label>
				<input id="filter-<?=$args['post']?>-lead-others-id" name="filter-<?=$args['post']?>-lead-others-id" type="text" class="input input-block input-box" placeholder="Search for team member" />
			</div>
