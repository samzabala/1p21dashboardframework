<div class="module position-relative">
	<div class="module-content">
		<div class="input-wrapper input-wrapper-block input-wrapper-vertical p">
			...
			<input id="task-project-REPLACEwithTaskId" name="task-project-REPLACEwithTaskId" type="text" class="input input-single-line input-select" data-toggle="dropdown" placeholder="Type or select project..." />
			<div class="dropdown dropdown-top-flush dashboard-dropdown-maxed no-padding" data-dropdown-width="100%" data-dropdown-max-height="322px">
				<ul class="list-group list-group-compact">
					...
					<li class="font-weight-700 color-neutral task-project-new">
						<a href="#">
							Create new client
		...
		<div class="input-wrapper input-wrapper-block input-wrapper-vertical p">
			...
			<input id="task-client-REPLACEwithTaskId" name="task-client-REPLACEwithTaskId" type="text" class="input input-single-line input-select" data-toggle="dropdown"  placeholder="Type or select client..." />
			<div class="dropdown dropdown-top-flush dashboard-dropdown-maxed no-padding" data-dropdown-width="100%" data-dropdown-max-height="322px">
				<ul class="list-group list-group-compact">

					<!-- @NOTE Jenna took note of the ability to create new clients as well but the design includes redundant buttons if built out. This is a stable front end variation of the ui -->
					<li class="font-weight-700 color-neutral task-client-new">
						<a href="#">
							Create new client
							`<span class="current-value"><span class="REPLACE">current input value</span></span>`
						</a>
		...
		<div class="input-wrapper input-wrapper-block input-wrapper-vertical">
			...
			<input id="task-leads-REPLACEwithTaskId" name="task-leads-REPLACEwithTaskId" type="hidden" class="input input-single-line input-select" data-toggle="dropdown" placeholder="Type or select project..." />
			<div class="p">
				<!-- @LOOP component -->
		...
		<div class="flex-grid flex-grid-fixed flex-grid-no-gutter">
			<div class="flex-col-xs-12">
				...
				<span class="input-label" class="no-margin-y">Assigned To</span>
				...
				<a href="#" data-toggle="dropdown" class="disply-inline-block p">Edit assignees</a>
				<?php app_get_component('components/dropdown-users-multiple'); ?>
			...
			<div class="flex-col-xs-6 flex-col-md-8">
				...
				<div class="p color-neutral no-margin-bottom">
					<a href="#" data-toggle="dropdown" class="task-due-date">
						<!--
							@NOTE 
			...
			<div class="flex-col-xs-6 flex-col-md-4">
				...
				<label class="input-label" for="task-priority-REPLACEwithTaskId" class="no-margin-y">Priority</label>
				<div class="color-neutral no-margin-bottom">
					<!-- @NOTE dynamic. text will change based on selected settngs -->
					<a href="#" data-toggle="dropdown" class="task-priority">
