<div class="module-function filter-dropdown-project position-static">
	
	<div class="background-theme input-group input-group-horizontal input-block-mobile">
		<button class="btn btn-default" data-toggle="dropdown">
			Filter
			<!-- if one or more filters are active -->
			<span class="filter-counter">
				(3)
			</span>
			<i class="symbol color-primary symbol-caret-down"></i>
		</button>
		<input type="text" class="input input-single-line" name="workflow-filter-projects" placeholder="Search projects..." size="30">
		<button type="submit" class="btn btn-default color-primary btn-symbol hide-mobile"><i class="symbol symbol-search"></i></button>
	</div>
