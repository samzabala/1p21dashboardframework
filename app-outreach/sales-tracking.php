	...
	<div class="table-wrapper">
		...
		<table class="table-fixed outreach-table">
			<tr>
				...
				<th class="text-nowrap  outreach-table-cell-columnwidth-300">Product</th>
				...
				<td class="outreach-table-cell-actions text-align-center" width="50">
					<div class="salestracking-actions position-relative">
						<?php app_get_component('components/modal-actions','',false,array(
							'links' => array(
								'Edit Details'
									=> 'href="#m-editor-proposed-products" data-toggle-modal-default data-modal-title="Edit Sale"',
								'Change Status'
