				...
				<div class="module module-expanded" data-grid-row-sm="2" >
					<div class="module-content">
						<div class="input-wrapper input-wrapper-block input-wrapper-vertical p">
							<label for="login-user" class="input input-label">Email or Username</label>
							<input id="login-user" name="login-user" type="text" placeholder="email@domain.com" class="input input-box input-large">
						</div>
						<div class="input-wrapper input-wrapper-block input-wrapper-vertical">
							<label for="login-password" class="input input-label">Password</label>
							<input id="login-password" name="login-password" type="passworc" placeholder="********" class="input input-box input-large">
						</div>
						<div class="grid grid-flex grid-compact grid-flex-fixed">
							<div class="grid-col-xs-6 text-align-left">
								<div class="input-wrapper input-wrapper-horizontal">
								<label for="login-remember" class="input input-label font-weight-inherit">
