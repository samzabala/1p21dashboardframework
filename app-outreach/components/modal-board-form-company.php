...
<div class="modal modal-board" id="mb-editor-company" data-modal-title="Edit Company" data-modal-width="770px">
        ...
        <form action="" class="grid grid-flex grid-flex-fixed">
            ...
            <div class="grid-col-xs-12 grid-col-sm-6">
                <div class="input-wrapper input-wrapper-block input-wrapper-vertical">
                    <label class="input input-label" for="company-lead-source">Lead Source</label>
                    <select class="input input-box input-box input-box-select" type="text" name="company-lead-source" id="company-lead-source">
            ...
            <div class="grid-col-xs-12 grid-col-sm-6">
                <div class="input-wrapper input-wrapper-block input-wrapper-vertical">
                    <label class="input input-label" for="company-status">Status</label>
                    <select class="input input-box input-box input-box-select" type="text" name="company-status" id="company-status">
            ...
            <div class="grid-col-xs-12 grid-col-sm-6">
                <div class="input-wrapper input-wrapper-block input-wrapper-vertical">
                    <label class="input input-label">Marketing Budget</label>
                    <div class="input-group input-group-horizontal input-block">
                        
                    <input class="input input-box" type="number" name="company-budget-min"  placeholder="Min" id="company-budget-min" />
                    <input class="input input-box" type="number" name="company-budget-max"  placeholder="Max" id="company-budget-max" />
                    </div>
                </div>
            </div>
            ...
            <div class="grid-col-xs-12">
                <div class="input-wrapper input-wrapper-block input-wrapper-vertical">
                    <label class="input input-label" for="company-emails">Emails</label>
            ...
            <div class="grid-col-xs-12">
                <div class="input-wrapper input-wrapper-block input-wrapper-vertical">
                    <label class="input input-label" for="company-phone-numbers">Phone Numbers</label>
            ...
            <div class="grid-col-xs-12">
                <div class="input-wrapper input-wrapper-block input-wrapper-vertical">
                    <label class="input input-label" for="company-websites">Websites</label>
            ...
            <div class="grid-col-12 text-align-right">
