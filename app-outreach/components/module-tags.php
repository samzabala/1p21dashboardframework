    ...
    <div class="module-content">
        <!-- @if has tags -->
            ...
            <!-- @PLACEHOLDER: DELETE WHEN READY -->
                <span class="tag outreach-palette-tag-company">Talent Agency</span>
                <span class="tag outreach-palette-tag-company">Law Firm</span>
                <span class="tag outreach-palette-tag-company">Japanifornia Locations</span>
                <span class="tag outreach-palette-tag-company">Herlock Sholmes</span>
                <span class="tag outreach-palette-tag-company">Metal Detector</span>
                <span class="tag outreach-palette-tag-company">Spirit Medium Services</span>
                <span class="tag outreach-palette-tag-company">Jollibee</span>
                <span class="tag outreach-palette-tag-company">Eat your hamburgers Apollo</span>
                <span class="tag outreach-palette-tag-company">Can defeat Thanos</span>
                <span class="tag outreach-palette-tag-company">Defense Attorney for Orcas in Los Angeles California</span>
