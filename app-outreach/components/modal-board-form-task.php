	...
	<form action="" class="grid grid-flex grid-flex-fixed">
		<div class=" grid-col-xs-12">
			<div class="input-wrapper input-wrapper-block input-wrapper-vertical">
				...
				<input type="text" name="task-title" class="input input-box input-large" placeholder="Add title">	
			</div>
		</div>

		<div class=" grid-col-xs-3">
			<div class="input-wrapper input-wrapper-block input-wrapper-vertical position-relative">
				<label for="task-resource" class="input input-label">Resource Type</label>
				<select class="input input-box" name="task-resource">
		...
		<div class=" grid-col-xs-9">
			<!-- 
				...
				classes to add
					...
					.input-wrapper
						`disabled` => if [name=task-resource] value is empty
			-->
			<div class="input-wrapper input-wrapper-block input-wrapper-vertical position-relative">
			<?php $resource_is_contact = false; //@PLACEHOLDER. not needed in actual app. used to demonstrate logic for the label ?>
				<label for="task-resource-list" class="input input-label">Select <?= $resource_is_contact ? 'Contact' : 'Company' ?></label>
				<input list="task-resource-list-data" class="input input-box" name="task-resource-list" />
		...
		<div class="grid-col-md-8 grid-col-xs-12">
			<div class="input-wrapper input-wrapper-block input-wrapper-vertical position-relative">
				<label for="task-schedule-date" class="input input-label">Scheduled Date</label>
		...
		<div class="grid-col-md-4 grid-col-xs-12">
			<div class="input-wrapper input-wrapper-block input-wrapper-vertical">
				<label for="task-schedule-time" class="input input-label">Scheduled Time</label>
				<input type="time" name="task-time" class="input input-box">
			</div>
		</div>

		<div class="grid-col-md-5 grid-col-xs-12">
			<div class="input-wrapper input-wrapper-block input-wrapper-vertical position-relative">
				<label for="task-due-date" class="input input-label">Due Date</label>
				<a data-toggle-dropdown class="btn-group btn-block btn-group-horizontal btn-group-unite">
					<div class="btn btn-default justify-content-flex-start">
						<span class="REPLACE">Friday, April 20, 2069</span>
					</div>
		...
		<div class="grid-col-md-3 grid-col-xs-12">
			<div class="input-wrapper input-wrapper-block input-wrapper-vertical">
				<label for="task-due-time" class="input input-label">Due Time</label>
				<input type="time" name="task-due-time" class="input input-box">
			</div>
		</div>

		<div class="grid-col-md-4 grid-col-xs-12">
			<div class="input-wrapper input-wrapper-block input-wrapper-vertical">
				<label for="task-asignee" class="input input-label">Assignee</label>
				<select type="text" name="task-asignee" class="input input-box">
		...
		<div class=" grid-col-12">
			<div class="input-wrapper input-wrapper-block input-wrapper-vertical position-relative">
				<label for="task-note" class="input input-label">Task Note</label>
				<textarea class="input input-box input-box-multiline" name="task-note">
		...
		<div class=" grid-col-12">
			<div class="input-wrapper input-wrapper-block input-wrapper-vertical position-relative">
				<label for="task-time" class="input input-label">Add Attachments</label>
				<input type="file" multiple class="input input-box" name="task-attachments" />
			</div>
		</div>
