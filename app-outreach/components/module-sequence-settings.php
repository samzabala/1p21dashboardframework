...
<div class="module switch switch-idle  no-padding-y margin-bottom">
	<div class="module-header module-header-break no-margin-y padding-small-y pointer-reference">
    ...
    <div id="sequence-settings" class="module-content accordion no-margin-bottom padding-top border-width-thin-top border-style-solid-top border-color-theme-polar-contrast">
		<div class="input-wrapper input-wrapper-block input-wrapper-vertical p">
			<label for="sequence-name" class="input-label">Sequence Name</label>
			<input type="text" name=""  id="sequence-name" class=" input input-single-line" placeholder="Type a sequence name " />
		</div>


		<div class="flex-grid flex-grid-compact align-items-center">
			<div class="flex-child flex-1-1">
				
				<p for="sequence-name" class="input-label display-block">Sharing Options</p>
